...
if ((current_time >= market_open_time && current_time <= market_close_time) && !(current_day %in% c("Saturday", "Sunday"))) {
  ...
  tickers = list("QQQ", "TQQQ", "SQQQ", "SPXL", "SPXS", "TNA", "TZA", "IWM", "NVDU", "NVDD", "SPXL", "SPXU", "QLD", "QID", "PSQ", "TMV", "TMF", "TTT")
  ...
  op = "C:/Users/Charlie/Desktop/R Stuff/All_LETF_Cross"
  opf = file.path(op, paste("LETF_Option_Pull", Sys.Date(), sep = "_"))
